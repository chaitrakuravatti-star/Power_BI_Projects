...
This Power BI project presents an interactive Call Center Performance Dashboard that provides insights into monthly call activity, call duration, response time compliance (SLA), customer sentiment, and geographic distribution of calls.
The dashboard enables stakeholders to monitor operational efficiency and identify improvement areas in customer support services.
...
Displays detailed call-level data in tabular format, including:
Customer Name, City, Channel, Day Name, Call Reason, Customer Sentiment, Response Time (SLA status), Call Duration (Minutes)
